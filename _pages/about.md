...
- *Jun. 2024*. &nbsp;🚀🚀 We release [WI3D]([https://arxiv.org/abs/2312.10763](https://github.com/MSheng-Lee/MSheng-Lee.github.io/blob/main/papers/WI3D__Weakly_Incremental_3D_Detection_via_Foundation_Models.pdf)), the first approach that can generalize well-trained 3D detectors to learn novel classes with the aid of foundation models.
